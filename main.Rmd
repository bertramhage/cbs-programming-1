...
```{r}
# Replacing High with Above Avarage, medium with Average and low with Below Average from the "ExamScoreCategory" column just created

data$ExamScoreCategory <- gsub("High", "Above Avarage", data$ExamScoreCategory)

data$ExamScoreCategory <- gsub("Medium", "Avarage", data$ExamScoreCategory)

data$ExamScoreCategory <- gsub("Low", "Below Avarage", data$ExamScoreCategory)
